<template>
  <div class='basedom'>
    ...
    <XscIframe v-else-if="type==='iframe'" :id="id" :options="options" :view="this.view"></XscIframe>
    <XscCard v-else-if="type==='card'" :id="id" :options="options" :themeData="themeData" :theme="theme"></XscCard>
    <XscSlide v-else-if="type==='slide'" :id="id" :options="options"></XscSlide>
    <XscDiv v-else-if="type==='div'" :id="id" :options="options"></XscDiv>
  </div>
</template>
