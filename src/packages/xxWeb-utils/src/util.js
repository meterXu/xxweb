...
export function getLogFvConf(project){
    if(project.variable.appid&&project.variable.appid!=='<请配置>'&&project.variable.logfv){
        let logConf = {
            appId:project.variable.appid,
            appName:project.variable.appName||'',
            console:project.variable.logfv.console||false,
            enable:project.variable.logfv.enable||false,
            reportUrl:project.variable.logfv.reportUrl
        }
        return logConf
    }else{
        return null
